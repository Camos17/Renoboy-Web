...
<html lang="es">
	...
	<body>
		...
		<footer class="col-xs-12 no-padding estilo-footer">
			<div class="col-xs-12 hidden-md hidden-lg no-padding texto-sedes">
			...
			<div id="carousel-example-generic" class="carousel slide carousel-legal col-xs-12 col-md-3" data-ride="carousel" data-interval="false">
			...
			<div class="col-xs-12 col-md-9 col-lg-8 c2-footer">
				
			
				<div class="col-xs-12 col-md-4 no-padding texto-sedes2">
					<p class="text-center"><strong>Planta Renoboy Bogotá</strong><br>
					Calle 17A N° 69F - 58 Zona Industrial Montevideo<br>
				  	<a href="tel: Tel: (+571) 742 2779 ">Tel: (+571) 742 2779</a><br><br>
