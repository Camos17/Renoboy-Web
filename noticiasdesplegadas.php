	<?php include "header.php";?>
		...
		<div class="col-xs-12 no-padding content-wrapper noticias">
			<div class="hidden-xs col-sm-5 col-sm-offset-1 col-md-4 img-noticia-desplegada">
				<img class="img-responsive" src="http://placehold.it/225x385" alt="">	
			</div>
			<div class="col-xs-12 col-sm-5 noticia-desplegada">
				...
				<div class="col-xs-12 col-sm-12 no-padding btn-regreso-noticia">
					<a href="noticias.php"><i class="fa fa-chevron-circle-left"></i>Noticias de Interés</a>
				</div>			
			</div>
		</div>
