	<?php include "header.php";?>
			...
			<div class="col-xs-12 no-padding fondo-quienes-confian-renoboy">
				<div class="col-xs-12 layer-fondo-quienes-confian-renoboy">
					...
					<div class="col-xs-12 col-md-10 col-md-offset-1 contenido-quienes-confian-renoboy no-padding">
						<div class="col-xs-12 iconos-quienes-confian">
							<div class="col-xs-12 col-sm-6 col-md-4 icono-quienes-confian">
								<div class="col-xs-12 rueda-quienes-confian">
									<img class="img-resposive" src="img/ruedaquienesconfian.svg" alt="...">
									<p>+35</p>
								</div>
								<div class="col-xs-10 col-xs-offset-1 icono-quienes-confian2">
									<div class="col-xs-4 col-xs-offset-4">
										<img class="img-responsive" src="img/icono_35.svg" alt="">
									</div>					
								</div>
							...
							<div class="col-xs-12 col-sm-6 col-md-4 icono-quienes-confian">
								...
								<div class="col-xs-10 col-xs-offset-1 icono-quienes-confian2">
									<div class="col-xs-6 col-xs-offset-3">
										<img class="img-responsive" src="img/icono_30.svg" alt="">
									</div>					
								</div>
							...
							<div class="col-xs-12 col-sm-6 col-md-4 icono-quienes-confian">
								...
								<div class="col-xs-12 col-xs-offset-0 icono-quienes-confian2">
									<div class="col-xs-4 col-xs-offset-4">
										<img class="img-responsive" src="img/icono_15.svg" alt="">
									</div>					
								</div>
							...
							<div class="col-xs-12 col-sm-6 col-md-4 icono-quienes-confian">
								...
								<div class="col-xs-10 col-xs-offset-1 icono-quienes-confian2">
									<div class="col-xs-6 col-xs-offset-3">
										<img class="img-responsive" src="img/icono_10.svg" alt="">
									</div>					
								</div>
							...
							<div class="col-xs-12 col-sm-6 col-md-4 icono-quienes-confian">
								...
								<div class="col-xs-10 col-xs-offset-1 icono-quienes-confian2">
									<div class="col-xs-4 col-xs-offset-4">
										<img class="img-responsive" src="img/icono_5_1.svg" alt="">
									</div>					
								</div>
							...
							<div class="col-xs-12 col-sm-6 col-md-4 icono-quienes-confian">
								...
								<div class="col-xs-12 col-xs-offset-0 icono-quienes-confian2">
									<div class="col-xs-4 col-xs-offset-4">
										<img class="img-responsive" src="img/icono_5_2.svg" alt="">
									</div>					
								</div>
							...
							<div class="col-xs-12 col-sm-6 col-md-4 icono-quienes-confian">
								...
								<div class="col-xs-10 col-xs-offset-1 icono-quienes-confian2">
									<div class="col-xs-6 col-xs-offset-3">
										<img class="img-responsive" src="img/icono_5_3.svg" alt="">
									</div>					
								</div>
							...
							<div class="col-xs-12 col-sm-6 col-md-4 icono-quienes-confian">
								...
								<div class="col-xs-10 col-xs-offset-1 icono-quienes-confian2">
									<div class="col-xs-6 col-xs-offset-3">
										<img class="img-responsive" src="img/icono_5_4.svg" alt="">
									</div>					
								</div>
								<p class="col-xs-12 leyenda-quienes-confian">Más de 5 empresas de Alimentos y Bebidas.</p>
							</div>
						</div>
						<div class="col-xs-6 col-xs-offset-5 btn-porque-confian">
							<a class="col-xs-6 btn btn-block" href="" title="">¿POR QUÉ CONFIAN <br> EN RENOBOY? </a>
						</div>
